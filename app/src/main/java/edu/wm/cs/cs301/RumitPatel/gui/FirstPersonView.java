...
import edu.wm.cs.cs301.RumitPatel.generation.BSPBranch;
import edu.wm.cs.cs301.RumitPatel.generation.BSPLeaf;
import edu.wm.cs.cs301.RumitPatel.generation.BSPNode;
import edu.wm.cs.cs301.RumitPatel.generation.Floorplan;
import edu.wm.cs.cs301.RumitPatel.generation.Wall;
...
public class FirstPersonView {
	...
	public void draw(MazePanel panel, int x, int y, int walkStep, int ang, float percentToExit) {
        ...
        this.panel.addBackground(percentToExit);
        
        // set color to white and draw what ever can be seen from the current position
        this.panel.setColor(-1);
        //g.setColor(Color.decode("#000808")); 
