...
import edu.wm.cs.cs301.RumitPatel.gui.Map;
import edu.wm.cs.cs301.RumitPatel.gui.MazePanel;
...
public class StatePlaying extends DefaultState {
	...
	Map mapView;
    MazePanel panel;
    private PlayManuallyActivity playManual = null;
    private PlayAnimationActivity playAnimation = null;
	...
	public void setPlayManual(PlayManuallyActivity pm){
	    this.playManual = pm;
    }
    public void setPlayAnimation(PlayAnimationActivity pa){
        this.playAnimation = pa;
    }
    /**
    ...
    public boolean keyDown(UserInput key, int value) {
        if (!started) {
            Log.v("KeyDown:", "please start first");
            return false;
        }
