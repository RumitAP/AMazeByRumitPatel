...
import edu.wm.cs.cs301.RumitPatel.gui.P5PanelF21.P5RenderingHints;
...
public class CompassRose {
	...
	private static final int greenWM = -15640768; //Color.decode("#115740");
	private static final int goldWM = -7246015; //Color.decode("#916f41");
    ...
    private static final int CIRCLE_HIGHLIGHT = -855638017; //new Color(1.0f, 1.0f, 1.0f, 0.8f);
    //Color.decode("#115740").darker();// = new Color(1.0f, 1.0f, 1.0f, 0.8f);
    private static final int CIRCLE_SHADE = 1308622847; // new Color(1.0f, 1.0f, 1.0f, 0.3f);
    //Color.decode("#115740").brighter(); //new Color(0.0f, 0.0f, 0.0f, 0.2f);

    // fixed configuration for letters used to indicate direction
    private static final int MARKER_COLOR = -16777216; //Color.black;
    /**
	...
	private P5PanelF21 panel;
	
    /**
     * Construct a compass rose with the default settings.
     */
    public CompassRose(P5PanelF21 panel) {
        this(panel, 0.9, 4.5);
    }
     ...
     *
	 * @param panel			an instance of the Graphics wrapper, P5PanelF21
     ...
     *                      will position the markers outside of the bordering circle.
     */
    public CompassRose(P5PanelF21 panel, double scaler, double markerRadius) {
        this.scaler = scaler;
	...
	private void drawArms(final int length, final int width) {
        ...
        // draw each arm
        drawArmNorth(length +75, width+75, x, y);
        drawArmEast(length+75, width+75, x, y);
        drawArmSouth(length+75, width+75, x, y);
        drawArmWest(length+75, width+75, x, y);
	}
