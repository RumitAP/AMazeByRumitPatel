 ...
 *
 */
public class DefaultState extends AppCompatActivity implements State {
    ...
    @Override
	public void setRobotCrashed(boolean robotCrashed) {
        throw new RuntimeException(MSG_UNIMPLEMENTED_METHOD);
    }
    @Override
	public void setEnergyConsumped(float energyConsumed) {
        throw new RuntimeException(MSG_UNIMPLEMENTED_METHOD);
    }
}
