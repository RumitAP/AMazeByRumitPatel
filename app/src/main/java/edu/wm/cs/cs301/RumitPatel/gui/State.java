...
import edu.wm.cs.cs301.RumitPatel.generation.Order.Builder;
...
public interface State {
    ...
    /**
     * Sets whether the robot crashed, typically of interest for 
     * the final screen.
     * @param robotCrashed is whether the robot crashed - boolean.
     */
	void setRobotCrashed(boolean robotCrashed);
	 /**
     * Sets how much energy the robot consumed to solve the
     * maze, typically of interest for 
     * the final screen.
     * @param energyConsumed is how much energy was consumed.
     */
	void setEnergyConsumped(float energyConsumed);
